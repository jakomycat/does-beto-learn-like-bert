...
def run_full_sva_evaluation(X_train, y_train, X_val, y_val, X_test, y_test, buckets, num_classes, device, output_filename):
    ...
    for layer_idx in range(num_layers):
        ...
        # Model train
        model = ProbeClassifier(X_train_l.shape[1], num_classes).to(device)
